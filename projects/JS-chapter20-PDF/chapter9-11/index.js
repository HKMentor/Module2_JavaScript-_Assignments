...
if(color.toLowerCase() === "red"){
    ...
    alert("Ready to move")
}else if(color.toLocaleLowerCase() === "greeen"){
    alert("Move now")
}
...
// show the message “Please refill the fuel in your car”  5. Run this script, & check whether alert message would be 
...
var b = 82;
if(b++ === 83){
    alert("givn consition for varibale b is true ")
}
...
//f
if("car" < "cat"){
    alert(" <br> car is smaller than cat");
}
